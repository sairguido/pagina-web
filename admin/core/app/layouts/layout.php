...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SUDAMERIZ | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>SUDAMERIZ</b></span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./index.php?view=contactos"><i class='fa fa-phone'></i> <span>Contactos</span></a></li>
        <li class="treeview">
          <a href="#">
...
<div class="login-box">
      <div class="login-logo">
        <a href="./"><b>ADMINISTRADOR SUDAMERIZ</b></a>
        <br>
        <img src="dist/img/ico.png" alt="SUDAMERIZ" height="80">
      </div><!-- /.login-logo -->
